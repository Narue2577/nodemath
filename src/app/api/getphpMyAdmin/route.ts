...
export async function GET(request: Request) {
  try {
    ...
    get_exp_query =  'SELECT staff_id AS id, staff_buasri AS buasri, "teacher" AS role, staff_name AS name FROM staff WHERE staff_buasri !="NULL" UNION SELECT stu_id, stu_buasri, "student" AS role,stu_name FROM student'
